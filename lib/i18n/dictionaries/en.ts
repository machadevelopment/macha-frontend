...
export const en: Dictionary = {
  ...
  upload: {
    confirmacion: {
      ...
      verDetalle: 'See what we understood',
      ocultarDetalle: 'Hide',
      comoLeimos: 'Where each value came from',
      primerasFilas: 'First rows, as they landed',
      entroComo: 'Landed as',
      ...
      columnaHint: 'Pick the column the amount comes from and we will read this sheet again.',
      reprocesando: "We're reading that sheet again. It takes a moment.",
      sinDatos: '{n} sheet(s) with no data (cover pages, notes, instructions)',
      verSinDatos: 'See which',
  ...
  dashboard: {
    ...
    kpi: {
      ...
      expensesHint: 'Payroll, rent and the like. Excludes the cost of goods sold.',

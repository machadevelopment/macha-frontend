  ...
  upload: {
    confirmacion: {
      ...
      destino: {
        ...
        tiendas: 'Ventas por tienda',
        inventario: 'Inventario',
        sinPantalla: 'A ninguna cifra — queda guardado pero no suma en ningún reporte',
      },
      verDetalle: 'Ver qué entendimos',
      ocultarDetalle: 'Ocultar',
      comoLeimos: 'De dónde sacamos cada dato',
      primerasFilas: 'Las primeras filas, como quedaron',
      entroComo: 'Entró como',
      ...
      destinoDesc: {
        ...
        inventario: 'Es lo que tienes en existencia, no un gasto',
      },
      ...
      columnaHint: 'Elige la columna de la que sale el monto y volvemos a leer esta hoja.',
      reprocesando: 'Estamos volviendo a leer esa hoja. Tarda un momento.',
      sinDatos: '{n} hoja(s) sin datos (portadas, notas, instrucciones)',
      verSinDatos: 'Ver cuáles',
    ...
    conceptos: {
      ...
      destino: {
        ...
        tiendas: 'Ventas por tienda',
        inventario: 'Inventario',
        sinPantalla: 'No suma en ninguna pantalla',
      },
      vaA: 'Aparece en',
      motivo: {
        yaEsAsi: 'Ya está aquí',
        variasHojas: 'Sale de varias hojas',
      },
      cuenta: {
        invoice: 'Una cuenta por cobrar',
        bill: 'Una cuenta por pagar',

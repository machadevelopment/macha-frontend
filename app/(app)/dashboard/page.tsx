...
export default function DashboardPage() {
  ...
  return (
    /*
     * CU-868krkqh2: `PeriodScope` envuelve la pantalla completa porque el período lo
     * comparten el saludo (arriba) y las píldoras de KPI (dentro del grid), que no tienen
     * antepasado común más cercano. El provider es de cliente pero acepta `children` de
     * servidor, así que esta página sigue siendo un Server Component y el diccionario y el
     * locale se siguen resolviendo en el servidor.
     */
    <PeriodScope>
